...
tags: ["legislação eleitoral", "TSE", "tráfego pago eleitoral", "propaganda eleitoral digital", "eleições 2026"]
---
...
| Cargo | Limite estimado (com base em 2022, corrigido pela inflação) |
|---|---|
| Deputado Federal | R$ 3,5 a R$ 4 milhões |
...
A Agência Elefef tem experiência em campanhas eleitorais digitais dentro das normas do TSE. Emitimos nota fiscal de todos os serviços e fornecemos toda a documentação para a prestação de contas. [Solicite uma proposta](/orcamento).
