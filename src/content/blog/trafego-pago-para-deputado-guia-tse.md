---
title: "Tráfego Pago para Campanha de Deputado: Guia Completo dentro das Regras do TSE"
description: "Tudo que um candidato a deputado estadual ou federal precisa saber sobre tráfego pago eleitoral — o que é permitido pelo TSE, plataformas, prestação de contas e estratégias para 2026."
pubDate: 2026-02-14
author: "Luiz Felipe Freitas"
category: "Marketing Político"
tags: ["marketing político", "tráfego pago eleitoral", "deputado", "TSE", "campanhas eleitorais", "meta ads eleitoral"]
featured: true
---
...
1. **O investimento em mídia deve ser pago diretamente pelo candidato ou pelo partido** à plataforma (Meta, Google, etc.) — nunca via agência. Isso cria rastreabilidade do fluxo financeiro.

2. **A agência emite nota fiscal pelo serviço de gestão**, separada do valor de mídia.

3. **Guarde todos os comprovantes**: recibos das plataformas, notas fiscais da agência, extratos bancários.

4. **Informe o sistema do TSE** (SIGE ou SPCE conforme a eleição) com o fornecedor (agência), valor do serviço e descrição detalhada.
...
1. **Começar a campanha digital só após o início do período eleitoral oficial**: sem base prévia, o custo por resultado é muito mais alto.

2. **Não segmentar geograficamente**: candidatos que anunciam para todo o estado gastam em eleitores de outras zonas eleitorais que não podem votar neles.

3. **Ignorar a verificação de identidade nas plataformas**: o Meta e o Google podem suspender os anúncios eleitorais sem verificação prévia, deixando o candidato sem mídia no momento mais crítico.

4. **Misturar recursos próprios e de campanha sem rastreabilidade**: gera problemas na prestação de contas ao TSE.

5. **Não mensurar as métricas corretas**: impressões e curtidas não elegem ninguém. As métricas que importam são custo por visualização de vídeo completa, custo por clique no site, alcance por zona eleitoral e engajamento real.
...
A Agência Elefef é especialista em marketing político digital e já apoiou campanhas de deputado estadual e vereador. [Solicite uma proposta](/orcamento) e comece sua campanha digital com quem entende das regras do TSE.
